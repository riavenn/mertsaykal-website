...
function Header() {
  ...
  return (
    <div className="flex flex-col px-5 py-10 md:p-45 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row justify-center text-white gap-40 pt-10 md:pt-20">
        <div className="flex flex-col gap-5 items-center relative">
          <div className="">
            <img
              src={headerImage}
              alt="Mert Saykal"
              className="w-70 h-70 md:w-85 md:h-85 rounded-full border-4 border-gray-800 object-cover p-1"
            />
          </div>
          <div className="flex flex-col bg-white/10 backdrop-blur-md gap-3 border-2 border-white/20 shadow-xl p-3 rounded-lg absolute -bottom-30 right-5 md:-bottom-15 md:-right-20 z-999">
        ...
        <div className="flex flex-col justify-center items-center md-align-start gap-6 md:gap-8">
          <div className="flex flex-col gap-2">
            <div className="text-3xl md:text-5xl tracking-[1px]">
              <h1>Mert Saykal</h1>
            </div>
          ...
          <div className="text-lg text-center text-gray-400 md:w-100">
